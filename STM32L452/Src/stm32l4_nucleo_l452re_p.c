...
/** @defgroup NUCLEO_L452RE_P NUCLEO_L452RE_P
 * @{
 */   
    
/** @defgroup NUCLEO_L452RE_P_LOW_LEVEL NUCLEO_L452RE_P LOW LEVEL
...
/** @defgroup NUCLEO_L452RE_P_LOW_LEVEL_Private_Defines NUCLEO_L452RE_P LOW LEVEL Private Defines
 * @{
 */ 
 ...
 */  
#define __NUCLEO_L452RE_P_BSP_VERSION_MAIN   (0x01) /*!< [31:24] main version */
#define __NUCLEO_L452RE_P_BSP_VERSION_SUB1   (0x02) /*!< [23:16] sub1 version */
#define __NUCLEO_L452RE_P_BSP_VERSION_SUB2   (0x06) /*!< [15:8]  sub2 version */
#define __NUCLEO_L452RE_P_BSP_VERSION_RC     (0x00) /*!< [7:0]  release candidate */ 
#define __NUCLEO_L452RE_P_BSP_VERSION        ((__NUCLEO_L452RE_P_BSP_VERSION_MAIN << 24)\
                                                    |(__NUCLEO_L452RE_P_BSP_VERSION_SUB1 << 16)\
                                                    |(__NUCLEO_L452RE_P_BSP_VERSION_SUB2 << 8 )\
                                                    |(__NUCLEO_L452RE_P_BSP_VERSION_RC))
/**
 * @}
 */ 

/** @defgroup NUCLEO_L452RE_P_LOW_LEVEL_FunctionPrototypes NUCLEO_L452RE_P LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup NUCLEO_L452RE_P_LOW_LEVEL_Private_Variables NUCLEO_L452RE_P LOW LEVEL Private Variables
 * @{
 */
...
{
  return (int32_t)__NUCLEO_L452RE_P_BSP_VERSION;
}
